...
//TIMER
char sql_Create_mod_TIMER[] = "CREATE TABLE IF NOT EXISTS chud_TIMER (steamid VARCHAR(32) NOT NULL, enabled INT(12) NOT NULL DEFAULT '0', pos VARCHAR(32) NOT NULL DEFAULT '0.5|0.5', holdtime INT(12) NOT NULL DEFAULT '3', gaincolor VARCHAR(32) NOT NULL DEFAULT '255|255|255', losscolor VARCHAR(32) NOT NULL DEFAULT '255|255|255', maintaincolor VARCHAR(32) NOT NULL DEFAULT '255|255|255', FormatOrderbyID VARCHAR(64) NOT NULL DEFAULT '0|0|0', PRIMARY KEY(steamid)) DEFAULT CHARSET=utf8mb4;";
...
//GLOBAL OPTIONS
char sql_Create_OPTIONS[] = "CREATE TABLE IF NOT EXISTS chud_OPTIONS (steamid VARCHAR(32) NOT NULL, refreshrate INT(12) NOT NULL DEFAULT '1', PRIMARY KEY(steamid)) DEFAULT CHARSET=utf8mb4;";