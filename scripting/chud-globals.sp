...
char g_szSPEED_MODULE[MAXPLAYERS + 1][SPEED_SUBMODULES * 32];
...
char g_szTIMER_SUBMODULE_INDEXES_STRINGS[MAXPLAYERS + 1][TIMER_SUBMODULES][64];
int g_iTIMER_SUBMODULES_INDEXES[MAXPLAYERS + 1][TIMER_SUBMODULES];
char g_szTIMER_MODULE[MAXPLAYERS + 1][TIMER_SUBMODULES * 64];
...
char g_szINPUT_SUBMODULE_INDEXES_STRINGS[MAXPLAYERS + 1][INPUT_SUBMODULES][64];
int g_iINPUT_SUBMODULES_INDEXES[MAXPLAYERS + 1][INPUT_SUBMODULES];
char g_szINPUT_MODULE[MAXPLAYERS + 1][INPUT_SUBMODULES * 64];
...
char g_szINFO_SUBMODULE_INDEXES_STRINGS[MAXPLAYERS + 1][INFO_SUBMODULES][64];
int g_iINFO_SUBMODULES_INDEXES[MAXPLAYERS + 1][INFO_SUBMODULES];
char g_szINFO_MODULE[MAXPLAYERS + 1][INFO_SUBMODULES * 64];
...
//===SPEED MODULE===
//CSD
char g_szCSD_SUBMODULE[MAXPLAYERS + 1][64];
...
//===TIMER MODULE===
//CHECKPOINTS
char g_szCP_SUBMODULE[MAXPLAYERS + 1][64];
...
//TIMER
char g_szSTOPWATCH_SUBMODULE[MAXPLAYERS + 1][64];

bool g_bStopwatch[MAXPLAYERS + 1];

//FINISH
char g_szFINISH_SUBMODULE[MAXPLAYERS + 1][64];
...
//===INPUT MODULE===
//KEYS
char g_szKEYS_SUBMODULE[MAXPLAYERS + 1][64];
...
//SYNC
char g_szSYNC_SUBMODULE[MAXPLAYERS + 1][64];

bool g_bSync[MAXPLAYERS + 1];

//===INFO MODULE===
//MAP INFO
char g_szMAPINFO_SUBMODULE[MAXPLAYERS + 1][64];
...
//STAGE INFO
char g_szSTAGEINFO_SUBMODULE[MAXPLAYERS + 1][64];

bool g_bStageInfo[MAXPLAYERS + 1];

//STAGE INDICATOR
char g_szSTAGEINDICATOR_SUBMODULE[MAXPLAYERS + 1][64];
